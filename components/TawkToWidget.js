...
export default function TawkToWidget() {
  ...
  return (
    <>
      {/* Chat Icon */}
      <div
        className={`fixed bottom-2 right-3 z-50 hidden md:block flex flex-col items-center justify-center transition-opacity duration-200 ${
      ...
      >
        ...
        <span className="text-[18px] text-[#FFFFFF] font-bold mb-4">
          Contact Us
        </span>
      </div>
